...
const Contact = ({ visible }) => {
  ...
  const sendEmail = async (e) => {
    ...
    const response = await axios.post(
      `https://elavateVapar.net/emails/contactus_form`,
      {
  ...
  return (
    <div>
      ...
      >
        <button
          type="submit"
          className="bg-[--primary-color] hover:bg-[--primary-color] text-white text-xl font-bold py-2 px-6 h-14 w-56 rounded focus:outline-none focus:shadow-outline"
        >
          Get in touch
        </button>
      </div>
      ...
      >
        <div className="bg-[--primary-color] h-full p-12 flex flex-col  rounded-tl-md rounded-bl-md">
          ...
          <div className="">
            ...
            <div className="flex flex-row my-8 gap-x-4">
              ...
              <h2 className="text-white text-[16px] mb-0 pb-0 font-[400]">
                elavateVapar C/O Whizdom Club <br /> Savitri Cinema Complex,{" "}
                <br /> Near Greater Kailash Metro, <br /> Block E Greater
                Kailash II, <br /> New Delhi, Delhi 110048
              </h2>
            </div>
          </div>
          <div className="md:mb-[-2rem] flex items-end md:justify-start justify-center   md:ml-2 gap-4">
            <Link
              to="https://api.whatsapp.com/send/?phone=919810113654&text&type=phone_number&app_absent=0"
              target="_blank"
            >
              <img src={whatsapp} alt="" className="h-7" />
            </Link>
            <a
            ...
            <a href="https://www.instagram.com/elavateVapar/" target="_blank">
          ...
          <div className="relative top-[-62px]  md:left-[245px] ">
            ...
            <div className="z-10 md:flex hidden">
              <svg
                ...
                fill="none"
              >
                <circle cx="126.557" cy="126.833" r="125.953" fill="#492000" />
              </svg>
            </div>
          </div>
        ...
        <div className="bg-white md:px-8 px-4   md:w-[40%] w-[100%] h-full py-20 shadow-2xl">
          ...
          >
            <div className="grid grid-cols-2 gap-8">
              <div className="mb-4">
                ...
                <input
                  ...
                  name="firstName"
                  id="name"
                  className="appearance-none border-b-2 border-[#8D8D8D] rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={firstName}
            ...
            <label htmlFor="option" className="text-black font-[600] mt-10">
              Select Subject?
            </label>
            ...
            <div className="my-8  mt-12">
              ...
              <textarea
                ...
                id="message"
                rows="3"
                className="shadow appearance-none border-b-2 border-[#8D8D8D] rounded w-full py-2 px-3 text-gray-700  focus:outline-none"
                value={message}
            ...
            <div className="flex items-center justify-end">
              <button
                type="submit"
                className="bg-[--primary-color] hover:bg-[--primary-color] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              >
                Send Message
              </button>
            </div>
