...
const ConsultingSessionBooking = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row  items-center justify-center min-h-screen bg-[--main-color]">
      ...
      <motion.div
        ...
        className="bg-white p-8 rounded-md shadow-md mt-8 md:mt-0 w-full md:w-1/3">
